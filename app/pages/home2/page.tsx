...
export default function Home() {
    ...
    return (
        <main className="pt-[calc(var(--navheight)+var(--space5))] sm:pt-[calc(var(--navheight)+var(--space22))] px-space5 pb-space5 min-w-screen min-h-screen flex flex-col justify-start items-center sm:items-start bg-color10 overflow-x-hidden">
            <div
                id="view1"
                className="w-screen max-w-full h-screen flex flex-col justify-around items-center overflow-x-hidden"
            >
            ...
            >
                ...
                >
                    ...
                    <div className="pt-space3">
                        We offer strategic architecting and consulting, as well
                        as innovation workshops. We provide technical leadership
                        and help to determine bounds of what’s currently
                ...
                >
                    ...
                    <div className="text-end">
                        ...
                        feasibility studies and rapid software prototype design
                        and development.
                    </div>
                </motion.div>

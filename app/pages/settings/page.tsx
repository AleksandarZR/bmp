...
export default function Settings() {
    return (
        <div className="pt-[calc(var(--navheight)+var(--space5))] sm:pt-[calc(var(--navheight)+var(--space22))] pb-space5 sm:pb-space22 px-space5 sm:px-space22 w-full min-h-screen grid grid-cols-3 sm:flex sm:flex-col gap-space5 sm:gap-space22 bg-color10 text-color1">
